...
class PelangganControllerTest extends TestCase
{
     ...
     * @test
     */
    public function it_displays_index_view_with_pelanggans()
    {
     ...
     * @test
     */
    public function it_displays_create_view_for_pelanggan()
    {
     ...
     * @test
     */
    public function it_displays_show_view_for_pelanggan()
    {
     ...
     * @test
     */
    public function it_displays_edit_view_for_pelanggan()
    {
        $pelanggan = Pelanggan::factory()->create();
